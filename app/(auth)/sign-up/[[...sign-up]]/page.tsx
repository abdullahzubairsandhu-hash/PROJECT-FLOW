...
export default function SignUpPage() {
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-zinc-950 px-4 overflow-hidden">
      {/* Background Ambient Glow - Emerald tint for 'New' actions */}
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center space-y-3 mb-10 animate-in fade-in slide-in-from-top-8 duration-1000">
          ...
          <p className="text-[11px] font-medium uppercase tracking-widest text-zinc-500">
            Create System Credentials to Begin
          </p>
        </div>
